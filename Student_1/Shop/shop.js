...
function addToCartClicked(event){ //updating the cart when a product is added to the cart from the store
    ...
    var title=shopItem.getElementsByClassName('item-title')[0].innerText //getting the title of the product from the store
    var price= shopItem.getElementsByClassName('item-price')[0].innerText //getting the price of the product from the store
    var imageSrc = shopItem.getElementsByClassName('item-image')[0].src //getting the image of the product from the store
